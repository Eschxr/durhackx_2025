...
export function Views({ className = "", ...props }: SVGPropsType) {
  return (
    <svg
      width={58}
      height={58}
...
export function Profit({ className = "", ...props }: SVGPropsType) {
  return (
    <svg
      width={58}
      height={58}
...
export function Product({ className = "", ...props }: SVGPropsType) {
  return (
    <svg
      width={58}
      height={58}
...
export function Users({ className = "", ...props }: SVGPropsType) {
  return (
    <svg
      width={58}
      height={58}
